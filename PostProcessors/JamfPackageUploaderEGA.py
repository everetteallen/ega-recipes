...
class JamfPackageUploaderEGA(Processor):
    ...
    def main(self):
        ...
        self.output(f"**********Package ID was {obj_id} ")
        if obj_id != "-1":
            self.output(
        ...
        self.output(f"**********Package Uploaded was {self.pkg_uploaded}")
        self.output(f"**********Replace Metadata was {self.replace_metadata}")
...
if __name__ == "__main__":
    PROCESSOR = JamfPackageUploaderEGA()
